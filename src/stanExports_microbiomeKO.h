...
namespace model_microbiomeKO_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_microbiomeKO");
    reader.add_event(32, 30, "end", "model_microbiomeKO");
    return reader;
}
#include <stan_meta_header.hpp>
class model_microbiomeKO
  : public stan::model::model_base_crtp<model_microbiomeKO> {
private:
        int N;
        int lengthZ;
        vector_d mu0;
...
public:
    model_microbiomeKO(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_microbiomeKO_namespace::model_microbiomeKO";
        ...
        try {
            ...
            validate_non_negative_index("Xvec", "(lengthZ + 1)", (lengthZ + 1));
            validate_non_negative_index("Xvec", "N", N);
            context__.validate_dims("data initialization", "Xvec", "int", context__.to_vec((lengthZ + 1),N));
            Xvec = std::vector<std::vector<int> >((lengthZ + 1), std::vector<int>(N, int(0)));
            vals_i__ = context__.vals_i("Xvec");
            pos__ = 0;
            size_t Xvec_k_0_max__ = (lengthZ + 1);
            size_t Xvec_k_1_max__ = N;
            for (size_t k_1__ = 0; k_1__ < Xvec_k_1_max__; ++k_1__) {
                for (size_t k_0__ = 0; k_0__ < Xvec_k_0_max__; ++k_0__) {
                    Xvec[k_0__][k_1__] = vals_i__[pos__++];
                }
            }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            validate_non_negative_index("theta", "(lengthZ + 1)", (lengthZ + 1));
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> theta((lengthZ + 1));
            stan::math::initialize(theta, DUMMY_VAR__);
            stan::math::fill(theta, DUMMY_VAR__);
            current_statement_begin__ = 16;
            validate_non_negative_index("thetasd", "(lengthZ + 1)", (lengthZ + 1));
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> thetasd((lengthZ + 1));
            stan::math::initialize(thetasd, DUMMY_VAR__);
            stan::math::fill(thetasd, DUMMY_VAR__);
            ...
            for (int i = 1; i <= lengthZ; ++i) {
                ...
                stan::model::assign(theta, 
                            ...
                            stan::math::exp(get_base1(Z, i, "Z", 1)), 
                            "assigning variable theta");
            }
            current_statement_begin__ = 21;
            stan::math::assign(thetasd, divide(theta, sum(theta)));
            // validate transformed parameters
            const char* function__ = "validate transformed params";
            (void) function__;  // dummy to suppress unused var warning
            current_statement_begin__ = 15;
            size_t theta_j_1_max__ = (lengthZ + 1);
            ...
            current_statement_begin__ = 16;
            size_t thetasd_j_1_max__ = (lengthZ + 1);
            for (size_t j_1__ = 0; j_1__ < thetasd_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(thetasd(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: thetasd" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable thetasd: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            // model body
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                lp_accum__.add(multinomial_log<propto__>(stan::model::rvalue(Xvec, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list())), "Xvec"), thetasd));
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_microbiomeKO_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            current_statement_begin__ = 15;
            validate_non_negative_index("theta", "(lengthZ + 1)", (lengthZ + 1));
            Eigen::Matrix<double, Eigen::Dynamic, 1> theta((lengthZ + 1));
            stan::math::initialize(theta, DUMMY_VAR__);
            stan::math::fill(theta, DUMMY_VAR__);
            current_statement_begin__ = 16;
            validate_non_negative_index("thetasd", "(lengthZ + 1)", (lengthZ + 1));
            Eigen::Matrix<double, Eigen::Dynamic, 1> thetasd((lengthZ + 1));
            stan::math::initialize(thetasd, DUMMY_VAR__);
            stan::math::fill(thetasd, DUMMY_VAR__);
            ...
            if (include_tparams__) {
                ...
                size_t thetasd_j_1_max__ = (lengthZ + 1);
                for (size_t j_1__ = 0; j_1__ < thetasd_j_1_max__; ++j_1__) {
                    vars__.push_back(thetasd(j_1__));
                }
            }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        if (include_tparams__) {
            ...
            for (size_t j_1__ = 0; j_1__ < thetasd_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "thetasd" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        if (!include_gqs__) return;
...
typedef model_microbiomeKO_namespace::model_microbiomeKO stan_model;
#ifndef USING_R
